<?php
	...
	// connect to database
	$conn = new mysqli("localhost", "westenfi_admin", "yrN[fVW)pWW1", "westenfi_db");
	// Check connection
  ...
  // define global constants
	...
	define('BASE_URL', 'https://westenfield.co.ke/role/'); // the home url of the role
	define('BASE_URL_1', 'https://westenfield.co.ke/'); // the home url of the website
	// ...More code here ...
