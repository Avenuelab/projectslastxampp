                                    ...
                                    <div class="single-product">
                                        <div class="product-img">
                                            ...
                                            <div class="add-actions">
                                                <ul>
                                                    <li><a class="uren-add_cart" href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" title="Add To Cart"><i class="ion-bag"></i></a>
                                                    </li>
