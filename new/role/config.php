...
error_reporting(E_ALL);
	// connect to database
	$conn = new mysqli("localhost", "root", "", "Washa_db");
	// Check connection
  ...
  // define global constants
	...
	define('BASE_URL', 'http://localhost/new/role/'); // the home url of the role
	define('BASE_URL_1', 'http://localhost/new/'); // the home url of the website
	// ...More code here ...
