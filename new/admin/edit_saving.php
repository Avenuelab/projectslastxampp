          ...
          <h3>Edit Savings</h3>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_content">
                    <form method="POST" action="proc/proc_saving" enctype="multipart/form-data">
                      <?Php
                      ...
                      <div class="card mb-100">
                        <div class="card-body">
                          <div class="col-md-12 ">
                            ...
                            <div class="col-md-6 col-sm-6">
                              <textarea class="form-control" rows="5" name="req_<?php echo $id ?>"><?php echo $row['requirement'];?></textarea>
                            </div>
                            <div class="col-md-6 col-sm-6">
                              <textarea class="form-control" rows="5" name="descr_<?php echo $id ?>"><?php echo $row['description'];?></textarea>
                            </div>                            
                          </div>                          
                        </div>
                      </div>
                      ...
                      <?php } ?>
                        <div class="col-md-4 col-sm-6 pt-90 pb-40">
                          <button type="submit" class="btn btn-success" name="saving">
                            <span class="fa fa-plus"></span> Update Savings
                          </button>
                        </div>                        
                    </form> 
