...
if(isset($_POST['submit']))
{
  ...
  $id=intval($_GET['id']);
$sql=mysqli_query($conn,"update category set categoryName='$category',categoryDescription='$description' where id='$id'");
      ...
      <div class="main_container">
        ...
        <form class="form-horizontal" method="post" name="Category">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="categoryName" name="category" placeholder="Enter category name" value="<?php echo htmlentities($row['categoryName']); ?>" required>
            </div>
            <div class="form-group">
