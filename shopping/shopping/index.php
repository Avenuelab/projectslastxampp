                    ...
                    <div id="hero" class="homepage-slider3">
                        <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                            <div class="full-width-slider">	
                                <div class="item" style="background-image: url(assets/images/sliders/slider1.png);"></div><!-- /.item -->
                            </div><!-- /.full-width-slider -->
                            
                            <div class="full-width-slider">
                                <div class="item full-width-slider" style="background-image: url(assets/images/sliders/slider2.png);"></div><!-- /.item -->
                            </div><!-- /.full-width-slider -->
                            ...
                            <div class="row">
                                ...
                                <div class="hidden-md col-sm-4 col-lg-4">
                                    <div class="info-box">
                                        ...
                                        <h6 class="text">Free ship on orders over Ksh. 15000.00</h6>	
                                    </div>
                                </div><!-- .col -->
                                ...
                                <div class="col-md-6 col-sm-4 col-lg-4">
                                    <div class="info-box">
                                        ...
                                        <h6 class="text">All items on sale up to 20% off</h6>	
                                    </div>
                                </div><!-- .col -->
                            </div><!-- /.row -->
...
<!-- For demo purposes – can be removed in production : End -->
