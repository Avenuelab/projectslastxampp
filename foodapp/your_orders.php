...
<head>
    ...
    <style type="text/css" rel="stylesheet">
        ...
        .dialog-panel { margin: 10px; }-serif; }
...
<body>
    <header id="header" class="header-scroll top-header headrom">
        ...
        .panel-body { background: #e5e5e5; background: radial-gradient(ellipse at center, #e5e5e5 0%, #ffffff 100%); font: 600 15px "Open Sans", Arial, sans.php"><img class="img-rounded" src="images/logo.png" alt="" width="18%"></a>
