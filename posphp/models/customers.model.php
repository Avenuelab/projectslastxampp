...
// CREATE CUSTOMER
function addCustomer($table, $data) {
...
// SHOW CUSTOMERS
function showCustomers($table, $item = null, $value = null) {
    if ($item != null) {
...
// EDIT CUSTOMER
function editCustomer($table, $data) {
...
// DELETE CUSTOMER
function deleteCustomer($table, $data) {
...
// UPDATE CUSTOMER
function updateCustomer($table, $item1, $value1, $value) {
