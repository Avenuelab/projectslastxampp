...
$year = date('Y');
$sales = monthlySales($year); // Ensure this function fetches sales data for the current year

// Calculate total monthly sales
$total_monthly_sales = 0;
foreach ($sales as $sale) {
    $total_monthly_sales += $sale['total_saleing_price']; // Assuming this contains the total sale price
}
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading clearfix">
                                    ...
                                    <div class="float-right">
                                        ...
                                        <span class="text-success"><?php echo remove_junk(number_format($total_monthly_sales, 2)); ?></span>
                                    </div>
                                </div>
