...
<?php include(ROOT_PATH . '/admin/users/puserLogic.php'); ?>
<?php
              ...
              <div class="col-md-6">
                ...
                <div class="form-group <?php echo isset($errors['role_id']) ? 'has-error' : '' ?>">
                  <label class="control-label">User Role</label>
				   <?php foreach ($roles as $role):  if ($role['name'] === $_SESSION['user']['role']): ?>
                  <input type="text" class="form-control" value="<?php echo $role['name'] ?>">
