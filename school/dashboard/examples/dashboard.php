<?php 
session_start();
include_once('../../roles/connection.php');
  $log_sess=$_SESSION['login'];
  if(!isset($log_sess)){
            echo "login Error ";
           echo '<meta http-equiv="refresh" content="2;URL=../../roles/index.php">';
   }else{ 
  $sql= "SELECT * FROM tbl_user WHERE username = '$log_sess'";
