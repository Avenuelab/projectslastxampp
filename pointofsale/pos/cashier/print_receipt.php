                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">KSHS<?php echo $order->prod_price; ?></td>
                                    <td class="col-md-1 text-center">KSHS<?php echo $total; ?></td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                    ...
                                    <td class="text-center">
                                        <p>
                                            <strong>KSHS<?php echo $total; ?></strong>
                                        </p>
                                        <p>
                                            <strong>16%</strong>
                                        </p>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong>KSHS<?php echo $total; ?></strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
