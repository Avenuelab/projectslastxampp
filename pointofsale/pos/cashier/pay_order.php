              ...
              <form  method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="pay_code" value="<?php echo $order_code; ?>" class="form-control" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <button type="submit" name="pay" value="Pay Order" class="btn btn-success" value="">Pay Order</button>
                  </div>
                </div>
              </form>
            </div>
