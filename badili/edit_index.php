			...
			<div class="right_col" role="main">
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form enctype="multipart/form-data" class="form-horizontal form-label-left" method="POST" action="proc/index_proc">
                    <?php
                    $i=0;
                    ...
                    $rowHm=mysqli_fetch_array($hmQuery); ?>									
									<form method="POST" action="proc/index_proc">
										<div class="card">
											<div class="card-body">
