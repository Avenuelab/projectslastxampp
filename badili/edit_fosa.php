...
ul#menu li {
  ...
  color: blue;
                    ...
                    <ul id="menu" style="list-style-type: none;">
                      <li ><a href="#fosa" >FOSA</a></li>
                      <li><a href="#festive" >IDD/CHRISTMAS</a></li>
                      <li><a href="#devt" >DEVELOPMENT </a></li>
                      <li><a href="#express" >EXPRESS </a></li>
                      <li><a href="#advance" >ADVANCE</a></li>
                      <li><a href="#sos" >SOS </a></li>
                      <li><a href="#major" >MAJOR </a></li>
                      <li><a href="#beba" >BEBABEBA </a></li>
                      <li><a href="#biashara" >BIASHARA </a></li>
                      <li><a href="#overdraft" >OVERDRAFT</a></li>
                    </ul>              
            </nav>
            <div class="row">
