          ...
          <h3>Edit Member Benefits</h3>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_content">
                    <form method="POST" action="proc/proc_member_benefit">
                      <?Php
                        $benSql="SELECT * FROM member_benefit ";
                        ...
                        <div class="card-body">
                          <div class="col-md-12 ">
                            ...
                            <div class="col-md-4 col-sm-6">
                              <input type="text" class="form-control" name="name_<?php echo $id ?>" value="<?php echo $rowBen['name'];?>">
                            </div>
                              
                            <div class="col-md-6 col-sm-6 pb-10">
                              <textarea class="form-control" rows="5" name="descr_<?php echo $id ?>"><?php echo $rowBen['description'];?></textarea>
                            </div>                            
                          </div>                          
                        </div>
                      </div>
                      ...
                      <?php } ?>
                        <div class="col-md-4 col-sm-6 pt-90 pb-40">
                          <button type="submit" class="btn btn-success" name="ben">
                            <span class="fa fa-plus"></span> Update Benefits
                          </button>
                        </div>                        
                    </form> 
